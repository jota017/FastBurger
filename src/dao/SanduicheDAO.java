...
public class SanduicheDAO {
    ...
    public void salvar(Usuario usuario) throws SQLException{
        ...
        try {
            ...
            stmt.setInt(1, usuario.getIdsanduichefb());
    ...
    public void ExcluirSanduiche(Usuario objUsuario) {
    
    try {
    PreparedStatement stmt = connection.prepareStatement("DELETE FROM sanduichefb WHERE idsanduichefb=?");
    stmt.setInt(1,objUsuario.getIdsanduichefb());
    stmt.execute();
    JOptionPane.showMessageDialog(null, "Sanduiche excluido com sucesso!");
    } catch (SQLException ex) {
        JOptionPane.showMessageDialog(null, "Erro ao excluir o sanduiche!/nERRO: " + ex);
    ...
    public ArrayList listarSanduiches() {
        try {
     ...
     public void deletar(Usuario objUsuario) {
        try {
            String sql;
            if (!String.valueOf(objUsuario.getIdsanduichefb()).isEmpty()) {
